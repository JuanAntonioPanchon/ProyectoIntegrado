...
// * @author Panchon
// */
//@WebFilter(filterName = "FiltroAdmin", urlPatterns = {"/admin/*", "/graficas/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE, DispatcherType.ERROR})
