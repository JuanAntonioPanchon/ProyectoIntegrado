        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menuUsuario">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-3">
                        <a class="nav-link text-black" href="${pageContext.request.contextPath}/Controladores.ListaCompra/ControladorListaCompra">
                            <i class="bi bi-card-checklist me-1"></i> Lista Compra
                        </a>
                    </li>
                    <li class="nav-item mx-3">
                        <a class="nav-link text-black" href="${pageContext.request.contextPath}/Controladores.Usuarios/ControladorUsuarios?editar=true&id=${usuario.id}">
                            <i class="bi bi-person-circle me-1"></i> Perfil
                        </a>
                    </li>

                    <li class="nav-item mx-3">
                        <a class="nav-link text-black" href="${pageContext.request.contextPath}/Controladores.Pedidos/ControladorPedidosUsuario">
                            <i class="bi bi-basket me-1"></i> Pedidos
                        </a>
                    </li>

                    <li class="nav-item mx-3">
                        <a class="nav-link text-black" href="${pageContext.request.contextPath}/Controladores.Carrito/ControladorCarrito">
